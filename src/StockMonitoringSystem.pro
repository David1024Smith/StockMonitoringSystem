...
other.path=/opt/durapps/stockmonitoringsystem
other.files= $$PWD/../install/*

desktop.path = /usr/share/applications/
desktop.files = $$PWD/../install/stockmonitoringsystem.desktop


qnx: target.path = /opt/durapps/stockmonitoringsystem
else: unix:!android: target.path = /opt/durapps/stockmonitoringsystem
